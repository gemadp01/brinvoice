<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Tambah Format Invoice') }}
        </h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="post" action="{{ route('formats.store') }}" class="space-y-6 w-full">
                @csrf
                        ...
                        <div class="p-2 sm:p-4 bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg border border-gray-100 dark:border-gray-700">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <x-text-input id="sender_title" name="sender_title" type="text" class="py-1 text-base w-80" :value="old('sender_title', 'DITERBITKAN ATAS NAMA')" required autofocus autocomplete="sender_title"/>
                                        <x-input-error class="mt-2" :messages="$errors->get('sender_title')" />
                                    </div>
                                    <div class="flex gap-4 items-center mt-2">
                                        <div>
                                            <span class="text-gray-600 dark:text-gray-400">*</span>
                                            <x-text-input id="sender_label" name="sender_label" type="text" class="py-1 text-base" :value="old('sender_label', 'Penjual')" required autofocus autocomplete="name"/>
                                ...
                                <div>
                                    <div>
                                        <span class="text-gray-600 dark:text-gray-400">*</span>
                                        <x-text-input id="receiver_title" name="receiver_title" type="text" class="py-1 text-base w-80" :value="old('receiver_title', 'UNTUK')" required />
                                    </div>
                                    <div class="flex gap-4 items-center mt-2">
                                        <div>
                                            <span class="text-gray-600 dark:text-gray-400">*</span>
                                            <x-text-input id="receiver_label" name="receiver_label" type="text" class="py-1 text-base" :value="old('receiver_label', 'Pembeli')" required autofocus autocomplete="receiver_label"/>
                                    ...
                                    <div class="flex gap-4 items-center mt-2">
                                        <div>
                                            <span class="text-gray-600 dark:text-gray-400">*</span>
                                            <x-text-input id="invoice_date_label" name="invoice_date_label" type="text" class="py-1 text-base" :value="old('invoice_date_label', 'Tanggal Pembelian')" required autofocus autocomplete="invoice_date_label" />
                                    ...
                                    <div class="flex gap-4 items-center mt-2">
                                        <div>
                                            <span class="text-gray-600 dark:text-gray-400">*</span>
                                            <x-text-input id="invoice_address_label" name="invoice_address_label" type="text" class="py-1 text-base" :value="old('invoice_address_label', 'Alamat Pengiriman')" required autofocus autocomplete="invoice_address_label" />
                            ...
                            <div class="grid grid-cols-10 gap-4 items-center mt-2 border-y py-2 border-gray-900 dark:border-gray-600">
                                <div class="col-span-5">
                                    <span class="text-gray-600 dark:text-gray-400">*</span>
                                    <x-text-input id="item_label" name="item_label" type="text" class="py-1 text-base w-full" :value="old('item_label', 'INFO PRODUK')" required autofocus autocomplete="item_label" />
                                    <x-input-error class="mt-2" :messages="$errors->get('item_label')" />
                                </div>
                                <div class="col-span-1">
                                    <span class="text-gray-600 dark:text-gray-400">*</span>
                                    <x-text-input id="quantity_label" name="quantity_label" type="text" class="py-1 text-base w-full" :value="old('quantity_label', 'JUMLAH')" required autofocus autocomplete="quantity_label" />
                                    <x-input-error class="mt-2" :messages="$errors->get('quantity_label')" />
                                </div>
                                <div class="col-span-2">
                                    <span class="text-gray-600 dark:text-gray-400">*</span>
                                    <x-text-input id="price_label" name="price_label" type="text" class="py-1 text-base w-full" :value="old('price_label', 'HARGA SATUAN')" required autofocus autocomplete="price_label" />
                                    <x-input-error class="mt-2" :messages="$errors->get('price_label')" />
                                </div>
                                <div class="col-span-2">
                                    <span class="text-gray-600 dark:text-gray-400">*</span>
                                    <x-text-input id="price_total_label" name="price_total_label" type="text" class="py-1 text-base w-full" :value="old('price_total_label', 'TOTAL HARGA')" required autofocus autocomplete="price_total_label" />
                                ...
                                <div class="col-start-2 col-span-1">
                                    ...
                                    <div class="grid grid-cols-10 gap-4 items-center border-b border-gray-200 dark:border-gray-700 py-2">
                                        <div class="col-span-7">
                                            <span class="text-gray-600 dark:text-gray-400">*</span>
                                            <x-text-input id="subtotal_label" name="subtotal_label" type="text" class="py-1 text-base w-80" :value="old('subtotal_label', 'SUBTOTAL HARGA BARANG')" required autofocus autocomplete="subtotal_label" />
                                    ...
                                    <div class="grid grid-cols-10 gap-x-4 gap-y-1 items-center border-b border-gray-200 dark:border-gray-700 py-2">
                                        {{-- diskon --}}
                                        <div class="col-span-7">
                                            <x-text-input id="discount_label" name="discount_label" type="text" class="py-1 text-base w-full" :value="old('discount_label', 'Diskon')" autofocus autocomplete="discount_label" />
                                        ...
                                        {{-- ongkos kirim --}}
                                        <div class="col-span-7">
                                            <x-text-input id="shipment_label" name="shipment_label" type="text" class="py-1 text-base w-full" :value="old('shipment_label', 'Ongkos Kirim')" autofocus autocomplete="shipment_label" />
                                        ...
                                        {{-- biaya pajak --}}
                                        <div class="col-span-7">
                                            <x-text-input id="tax_label" name="tax_label" type="text" class="py-1 text-base w-full" :value="old('tax_label', 'Biaya Pajak')" autofocus autocomplete="tax_label" />
                                        ...
                                        {{-- biaya pelayanan --}}
                                        <div class="col-span-7">
                                            <x-text-input id="service_label" name="service_label" type="text" class="py-1 text-base w-full" :value="old('service_label', 'Biaya Pelayanan')" autofocus autocomplete="service_label" />
                                    ...
                                    <div class="grid grid-cols-10 gap-4 items-center py-2">
                                        <div class="col-span-7">
                                            <span class="text-gray-600 dark:text-gray-400">*</span>
                                            <x-text-input id="bill_total_label" name="bill_total_label" type="text" class="py-1 text-base w-80" :value="old('bill_total_label', 'TOTAL TAGIHAN')" required autofocus autocomplete="bill_total_label" />
                            ...
                            <div class="grid grid-cols-2 gap-4 py-2 mb-6">
                                <div class="col-start-2 col-span-1">
                                    <div>
                                        <span class="text-gray-600 dark:text-gray-400">*</span>
                                        <x-text-input id="payment_method_label" name="payment_method_label" type="text" class="py-1 mb-1 text-base w-80" :value="old('payment_method_label', 'Metode Pembayaran')" required autofocus autocomplete="payment_method_label" />
                                        <x-input-error class="mt-2" :messages="$errors->get('payment_method_label')" />
                                    </div>
                                    <div>
                                        <span class="text-gray-600 dark:text-gray-400">*</span>
                                        <x-text-input id="payment_method_name" name="payment_method_name" type="text" class="py-1 mb-1 text-base w-64" :value="old('payment_method_name', 'BRI Virtual Account')" required autofocus autocomplete="payment_method_name" />
                                        <x-input-error class="mt-2" :messages="$errors->get('payment_method_name')" />
                                    </div>
                                    <div>
                                        <span class="text-gray-600 dark:text-gray-400">*</span>
                                        <x-text-input id="payment_method_number" name="payment_method_number" type="text" class="py-1 mb-1 text-base w-64" :value="old('payment_method_number', '000-0000-0000')" required autofocus autocomplete="payment_method_number" />
